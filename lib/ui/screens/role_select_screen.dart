...
class RoleSelectScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor =
        isDark ? const Color(0xFF10221c) : const Color(0xFFf6f8f7);
    final surfaceColor = isDark ? const Color(0xFF19332b) : Colors.white;
    final textColor =
        isDark ? Colors.white : const Color(0xFF111827); // gray-900 equivalent
    final subtitleColor = isDark
        ? const Color(0xFF9CA3AF)
        : const Color(0xFF4B5563); // gray-400 / gray-600
        ...
        child: InkWell(
          ...
          child: Column(
            children: [
              ...
              if (isPrimary)
                Container(
                    height: 4, width: double.infinity, color: primaryGreen),

              IntrinsicHeight(
                // Use IntrinsicHeight to make Row children adapt
                child: Row(
                  crossAxisAlignment: CrossAxisAlignment.stretch,
                  children: [
                    // Image Section (Left)
                    Expanded(
                      flex:
                          4, // equivalent to w-1/3 approx if we assume total 12
                      child: Container(
                        decoration: BoxDecoration(
                        ...
                        child: Container(
                          color: Colors.black.withOpacity(isDark
                              ? 0.3
                              : 0.0), // dim image slightly in dark mode
                        ),
                      ),
                    ),
