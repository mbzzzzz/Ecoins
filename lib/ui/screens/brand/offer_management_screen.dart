...
class _OfferManagementScreenState extends State<OfferManagementScreen> {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            TextField(controller: titleController, decoration: const InputDecoration(labelText: 'Offer Title', hintText: 'e.g. 20% Off Next Order')),
            const SizedBox(height: 12),
            TextField(controller: descriptionController, decoration: const InputDecoration(labelText: 'Description', hintText: 'Describe your offer...'), maxLines: 2),
            const SizedBox(height: 12),
            TextField(controller: costController, decoration: const InputDecoration(labelText: 'Points Cost'), keyboardType: TextInputType.number),
          ],
        ),
        actions: [
  ...
  Widget build(BuildContext context) {
     if (_isLoading) return const Scaffold(body: Center(child: CircularProgressIndicator(color: AppTheme.primaryGreen)));
     ...
     return Scaffold(
       ...
       appBar: AppBar(
         title: Text('Active Campaigns', style: TextStyle(color: isDark ? Colors.white : AppTheme.textMain)),
       ...
       body: _offers.isEmpty 
         ? Center(child: Text('No active offers. Launch one!', style: TextStyle(color: isDark ? Colors.grey[400] : AppTheme.textSub)))
         : ListView.separated(
             ...
             itemBuilder: (context, index) {
               ...
               return Card(
                 ...
                 child: ListTile(
                   ...
                   trailing: IconButton(
                     icon: Icon(Icons.delete_outline, color: isDark ? Colors.grey[500] : Colors.grey),
