...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<String?> _uploadImage() async {
    ...
    try {
      ...
      final fileName = '$userId-${DateTime.now().millisecondsSinceEpoch}.${kIsWeb ? "png" : fileExt}';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Edit Profile', style: GoogleFonts.outfit(color: isDark ? Colors.white : AppTheme.textMain, fontWeight: FontWeight.bold)),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              _buildTextField(context, _nameController, 'Enter your name', isDark, Icons.person_outline),
              ...
              const SizedBox(height: 8),
              _buildTextField(context, _bioController, 'Tell us about yourself', isDark, Icons.info_outline, maxLines: 3),
  ...
  Widget _buildTextField(BuildContext context, TextEditingController controller, String hint, bool isDark, IconData icon, {int maxLines = 1}) {
    return Container(
      decoration: BoxDecoration(
      ...
      child: TextField(
        ...
        style: GoogleFonts.inter(color: isDark ? Colors.white : AppTheme.textMain),
        maxLines: maxLines,
        decoration: InputDecoration(
          hintText: hint,
          hintStyle: GoogleFonts.inter(color: Colors.grey),
          prefixIcon: maxLines == 1 ? Icon(icon, color: Colors.grey) : Padding(padding: const EdgeInsets.only(bottom: 48), child: Icon(icon, color: Colors.grey)), 
